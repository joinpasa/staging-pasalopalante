...
/** Google's official multi-color "G" mark, for "Continue with Google" buttons. */
export default function GoogleIcon({ size = 18, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 18 18" aria-hidden="true" {...props}>
      <path
        fill="#4285F4"
